...
const ShowForms = () => {
  ...
  useEffect(() => {
    const fetchApplications = async () => {
      ...
      try {
        ...
        // Directly set the array from response
  ...
  // Update filterApplications to handle the new data structure
              ...
              <tr key={application.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 flex gap-2">
                  <button
                    onClick={() => {
                      navigate(
                        `/admin/manage-application/${application.id}`
                      );
                    }}
                  ...
                  <button
                    ...
                    className="ml-2 p-2 rounded-md text-red-600 hover:text-red-800 transition-colors duration-200"
                    title="Delete"
                  >
